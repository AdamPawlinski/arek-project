    ...
    <v-container class="supra-privacy-policy mt-16">
      ...
      <v-card class="d-flex flex-column align-center pa-10" height="100%">
        <v-card-text class="text-left">
          ...
          <p>
            ZGODA UŻYTKOWNIKA
            Korzystanie z Serwisu www.suprafinanse.pl przez Użytkownika oznacza, że Użytkownik akceptuje, że Administrator gromadzi oraz wykorzystuje dane osobowe zgodnie z niniejszą Polityką Prywatności.
          ...
          <p>
            ...
            firmom współpracującym przy realizacji usług, w tym dystrybutorom i producentom oferowanego sprzętu i materiałów.
            firmom kurierskim, dostawcom.
            PRAWA UŻYTKOWNIKA
            Prawa Użytkownika
